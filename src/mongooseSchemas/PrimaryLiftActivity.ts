...
const primaryLiftActivitySchema = new Schema<IPrimaryLiftActivity>({
  percentOfMax: {
    type: Number,
...
export const PrimaryLiftActivity = Activity.discriminator<IPrimaryLiftActivity>('PrimaryLiftActivity', primaryLiftActivitySchema); 